...
[ ! -e /usr/local/bin/lefthook ] || { echo "FAIL: lefthook installed despite empty lefthookVersion"; exit 1; }
[ ! -e /etc/git-hooks-readonly/pre-commit ] || { echo "FAIL: pre-commit dispatcher installed despite empty lefthookVersion"; exit 1; }
[ ! -e /etc/git-hooks-readonly/commit-msg ] || { echo "FAIL: commit-msg dispatcher installed despite empty lefthookVersion"; exit 1; }
